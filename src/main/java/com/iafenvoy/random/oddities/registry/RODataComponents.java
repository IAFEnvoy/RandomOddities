...
public final class RODataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Pair<NonNullList<ItemStack>, NonNullList<ItemStack>>>> AUTO_CRAFTER = register("auto_crafter", () -> DataComponentType.<Pair<NonNullList<ItemStack>, NonNullList<ItemStack>>>builder().persistent(Codec.pair(NonNullList.codecOf(ItemStack.OPTIONAL_CODEC), NonNullList.codecOf(ItemStack.OPTIONAL_CODEC))).build());
